...
const (
	...
	whyFoundationKnob = "ручка фундамента (corelib `dropguard.ApprovalEnv`): накатчик службы " +
		"читает её по наследству, и страница называет её так, как её набирает оператор"
