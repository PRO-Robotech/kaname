...
--
-- 513001_system_role_rules_speak_the_catalog_dictionary — правила доменных
-- системных ролей называют ресурс так, как его называет каталог типов.
--
-- Номер выведен из задачи (kacho#513) + порядковый разряд внутри неё, а не взят
-- из каталога: порядковая эра закрыта, и это первая миграция новой формы.
--
-- ─────────────────────────────────────────────────────────────────────────────
-- ПРЕДМЕТ
--
