...
// (выдать / отозвать / перечислить) — его сведение на общую поверхность заведено
// отдельным предметом. Перепись его СЧИТАЕТ и печатает, чтобы «не покрыт» было
// отличимо от «не существует».
//
// ─────────────────────────────────────────────────────────────────────────────
