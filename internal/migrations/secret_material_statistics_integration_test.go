...
var secretMaterialKeeps = map[string]string{
	...
	"human_sessions.password_change_required": "не материал, а ПРИЗНАК: булево требование " +
		"сменить пароль при следующем входе (Ф3-23). Кандидатом стало по слову " +
		"`password` в имени; двух значений признака статистика не раскрывает",
}
