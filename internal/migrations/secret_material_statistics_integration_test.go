...
var secretMaterialKeeps = map[string]string{
	...
	"interactive_clients.secret_verifier_set_at": "не секретный материал: МОМЕНТ заведения проверочного " +
		"значения секрета клиента (LINE-A-1, kacho#2721), а не само значение — само значение исключено " +
		"из статистики своей миграцией; момент ничего не восстанавливает",
