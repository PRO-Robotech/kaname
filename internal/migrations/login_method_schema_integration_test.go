...
//
//   - F4d-13 · способ — СТРОКА своей таблицы; строка несёт вид и проверочный
//     материал; исходный пароль в ней не выражается — поля нет, и это проверено
...
func TestIntegration_LoginMethodIsARowNotAColumn(t *testing.T) {
	...
	require.Equal(t,
		...
		got,
		"F4d-13: строка несёт владельца, вид и проверочный материал; ни одна колонка не пуста. "+
			"Уровень доверия и состояние здесь НЕ заведены — решение названо в шапке миграции")
