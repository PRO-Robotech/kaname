...
//     `fga_writer` — право модуля писать кортежи: якорь вне иерархии, на котором
//     оно висело прежде, снят вместе со своим типом (выдачей он не выражался и
//     отзыву не поддавался).
