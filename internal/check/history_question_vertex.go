...
//
// # ФОРМЫ ЗАПИСИ ВЫЗОВА, КОТОРЫЕ РАЗБОР ОБЯЗАН ЗНАТЬ
//
// Форма, о которой разбор не знает, не даёт ни красного, ни зелёного — она
// МОЛЧИТ, и записанное в ней оказывается вне наблюдения. Поэтому формы
// перечислены поимённо, и у каждой есть своя проба в инъекции.
//
...
// на собственном объяснении, а это ровно тот класс, который здесь и ловится.
