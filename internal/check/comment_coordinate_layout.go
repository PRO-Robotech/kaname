...
// краснел бы на каждом объяснении собственного предмета — проверка, судящая по
// слову, находит его в комментарии, который этот же предмет объясняет, и
// остаётся зелёной при снятой защите. Первая редакция этого файла так и
// покраснела: на строке выше, где форма с многоточием объявлена законной, —
// распознаватель формы не знал, а знал её только резолвер, до которого
// многоточие не доезжало.
//
// ─────────────────────────────────────────────────────────────────────────────
