...
//
// Что делать, если он сработал, — исходов четыре, пятого нет:
//
...
//  4. появился импорт, говорящий о почте, которого распознаватель не знает →
//     назвать его форму в самом гейте: транспорт — в `mailTransportTokens`,
//     не-транспорт — в `mailNotTransport`. Это единственный исход, где правка
//     гейта законна: отказ и заведён ради того, чтобы форма не осталась вне
//     наблюдения.
