...
// прав (§«Параллельные полосы одного механизма обязаны
...
// остаётся выражена отношением, а не самодельной проверкой
...
const (
	...
	subjectReadSelf
	// subjectReadClusterAdmin — верхний ярус супер-доступа (§Три
