...
func (r *strictDupFakeRepo) Reader(ctx context.Context) (kanamerepo.Reader, error) {
	return &strictDupFakeReader{repo: r}, nil
}
func (r *strictDupFakeRepo) Writer(ctx context.Context) (kanamerepo.Writer, error) {
...
// ненаречённое.
func (rd *strictDupFakeReader) Visibility() visibility.ReaderIface { return nil }
...
// «сузить нечем», и списочный use-case обязан на нём ОТКАЗАТЬ, а не листать
// ненаречённое.
func (r *strictDupFakeWriter) Visibility() visibility.ReaderIface { return nil }
...
// подставляют.
func (w *strictDupFakeWriter) EmitInviteMail(_ context.Context, intent outboxtypes.InviteMailIntent) (bool, error) {
	if intent.To == "" {
...
func (r *strictDupRoleReader) PrunedSelectorTypes(context.Context, []domain.RoleID) (map[domain.RoleID][]domain.PrunedSelectorType, error) {
