...
func (f *delFakeRepo) Reader(context.Context) (kanamerepo.Reader, error) {
	return &delFakeReader{repo: f}, nil
}
func (f *delFakeRepo) Writer(context.Context) (kanamerepo.Writer, error) {
...
// подставляют.
func (w *delFakeWriter) EmitInviteMail(_ context.Context, intent outboxtypes.InviteMailIntent) (bool, error) {
	if intent.To == "" {
