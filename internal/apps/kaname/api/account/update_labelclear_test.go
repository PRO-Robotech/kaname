...
func (r *lcaRepo) Reader(context.Context) (kanamerepo.Reader, error) {
	return &lcaReader{parent: r}, nil
}
func (r *lcaRepo) Writer(context.Context) (kanamerepo.Writer, error) {
...
// ненаречённое.
func (r *lcaReader) Visibility() visibility.ReaderIface { return nil }
...
// «сузить нечем», и списочный use-case обязан на нём ОТКАЗАТЬ, а не листать
// ненаречённое.
func (r *lcaWriter) Visibility() visibility.ReaderIface { return nil }
...
// подставляют.
func (w *lcaWriter) EmitInviteMail(_ context.Context, intent outboxtypes.InviteMailIntent) (bool, error) {
	if intent.To == "" {
