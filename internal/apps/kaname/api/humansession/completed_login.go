...
// редакция 11; задача PRO-Robotech/kaname#287). Завершение восстановления
// решает счёт здесь же (Ф3 Р10 редакция 13, Ф5 Р5 редакция 4, сценарий Ф5-25;
// задача PRO-Robotech/kaname#305).
//
...
// приходит значением. Остальной пакет держит ту же дисциплину: церемония и
// завершение восстановления читают способы до открытия транзакции, подтверждение
// заведения — только после явного отката, вход — только после фиксации.
//
