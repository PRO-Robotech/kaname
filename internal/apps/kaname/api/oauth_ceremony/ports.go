...
// Package oauth_ceremony — варианты использования церемонии OAuth 2.1
...
// токен-эндпоинте.
//
// Своего движка церемонии здесь нет и быть не должно: движок — фундамента
// (решение PRO-Robotech/kacho#2721). Имя каталога поэтому не совпадает с
// путём, которым задача kaname#423 (предикат п.2) называет исключённый свой
// движок ветки `2721`: одно имя для двух предметов читалось бы проверкой как
// возвращённый движок.
//
