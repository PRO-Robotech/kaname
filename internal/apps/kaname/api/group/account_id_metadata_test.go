...
func (f *fakeGrpRepo) Reader(context.Context) (kanamerepo.Reader, error) {
	return &fakeGrpReader{}, nil
}
func (f *fakeGrpRepo) Writer(context.Context) (kanamerepo.Writer, error) {
	return &fakeGrpWriter{}, nil
}
...
// подставляют.
func (w *fakeGrpWriter) EmitInviteMail(_ context.Context, intent outboxtypes.InviteMailIntent) (bool, error) {
	if intent.To == "" {
