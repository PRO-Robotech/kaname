...
func (r *lcgRepo) Reader(context.Context) (kanamerepo.Reader, error) {
	return &lcgReader{parent: r}, nil
}
func (r *lcgRepo) Writer(context.Context) (kanamerepo.Writer, error) {
...
// ненаречённое.
func (r *lcgReader) Visibility() visibility.ReaderIface { return nil }
...
// подставляют.
func (w *lcgWriter) EmitInviteMail(_ context.Context, intent outboxtypes.InviteMailIntent) (bool, error) {
	if intent.To == "" {
