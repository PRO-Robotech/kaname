...
// repo/kaname/pg/group_member_fga_outbox_integration_test.go; this unit test proves
...
// fakeMemberRepo is a kanamerepo.Repository whose Writer() records the group
// member-mutation + FGA tuple emits. Reader() is unused by doAdd/doRemove.
type fakeMemberRepo struct{ w *fakeMemberWriter }

func (r *fakeMemberRepo) Reader(context.Context) (kanamerepo.Reader, error) {
	return nil, assertNotCalled("Reader")
}
func (r *fakeMemberRepo) Writer(context.Context) (kanamerepo.Writer, error) { return r.w, nil }
func (r *fakeMemberRepo) Close()                                            {}

// fakeMemberWriter embeds kanamerepo.Writer (nil) so it satisfies the wide
