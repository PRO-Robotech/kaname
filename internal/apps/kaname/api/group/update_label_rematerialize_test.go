...
func (r *gremRepo) Reader(context.Context) (kanamerepo.Reader, error) {
	return &gremReader{parent: r}, nil
}
func (r *gremRepo) Writer(context.Context) (kanamerepo.Writer, error) {
	return &gremWriter{parent: r}, nil
}
func (r *gremRepo) Close() {}

// gremReader embeds kanamerepo.Reader (nil): any method Execute does not use panics.
...
// gremWriter embeds kanamerepo.Writer (nil): any method doUpdate does not use panics.
