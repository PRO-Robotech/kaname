...
func (f *scopeGroupRepo) Reader(context.Context) (kanamerepo.Reader, error) {
	return &scopeGroupReader{parent: f}, nil
}
func (f *scopeGroupRepo) Writer(context.Context) (kanamerepo.Writer, error) { return nil, nil }
