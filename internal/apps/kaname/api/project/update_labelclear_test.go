...
func (r *lcpRepo) Reader(context.Context) (kanamerepo.Reader, error) {
	return &lcpReader{parent: r}, nil
}
func (r *lcpRepo) Writer(context.Context) (kanamerepo.Writer, error) {
...
// ненаречённое.
func (r *lcpReader) Visibility() visibility.ReaderIface { return nil }
...
// подставляют.
func (w *lcpWriter) EmitInviteMail(_ context.Context, intent outboxtypes.InviteMailIntent) (bool, error) {
	if intent.To == "" {
