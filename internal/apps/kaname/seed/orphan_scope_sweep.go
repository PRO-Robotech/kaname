...
func NewOrphanScopeSweeper(repo kanamerepo.Repository, store OrphanScopeStore, cfg OrphanScopeConfig) *OrphanScopeSweeper {
...
func (s *OrphanScopeSweeper) revokeScope(ctx context.Context, sc OrphanScope) (bindings, tuples int, skipped bool, err error) {
	...
	terr := shared.DoWithWriteTxVoid(ctx, s.repo, func(ctx context.Context, w kanamerepo.Writer) error {
...
func orphanScopeStillAlive(ctx context.Context, w kanamerepo.Writer, sc OrphanScope) (bool, error) {
	var err error
