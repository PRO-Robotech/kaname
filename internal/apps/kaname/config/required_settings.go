...
var RequiredSettings = []RequiredSetting{
	...
	},
	{
		...
		Conditional:            true,
		Sample:                 "2160h",
		Why: "срок ключа подписи (Go duration) — политика его ротации. Умолчания нет: срок, " +
			"выбранный за оператора, он не увидит и не пересмотрит, а страж, судящий " +
			"подставленную величину, не отказал бы ни разу",
