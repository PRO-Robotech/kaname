...
var LaneRequirements = []LaneRequirement{
	...
	// ПЯТЬ СТРОК ПОЛОСЫ ВХОДА (Ф3, kacho#1269): величины, без которых полоса
	// входа паролем не собирается, объявляет профиль; незаданная — отказ старта
	// с именем ручки (Ф1 §7 инв. 4; Ф3-28, Ф3-33, Ф3-41, Ф3-42). Под `external`
	// полосы нет, и её величины не требуются.
	{
		Lanes:   laneOwn,
