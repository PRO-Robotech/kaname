...
// допустимых алгоритмов — стражем своей чеканки; потолок длительности
// утверждения и допуск часов настройками не являются вовсе (объявлены числом в
// одном месте и приезжают в сборку параметром), поэтому незаданными быть не
