...
func (h *Handler) List(ctx context.Context, req *iamv1.ListAccountsRequest) (*iamv1.ListAccountsResponse, error) {
	...
	// сырой страницы, поэтому и на границе транспорта судится она. Общая
	// ValidateRawPagination приняла бы токен прежней формы, и обход, начатый до
	// выкатки, продолжился бы приблизительно — молча пропуская строки.
