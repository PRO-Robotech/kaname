...
// pending user-id.
func seedInviterAndPendingInvite(t *testing.T, ctx context.Context, repo *kanamepg.Repository, suffix, inviteeEmail string) (domain.UserID, domain.AccountID, domain.UserID) {
	t.Helper()
