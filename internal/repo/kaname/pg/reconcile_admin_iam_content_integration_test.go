...
func seedAdminRulesRole(t *testing.T, ctx context.Context, pool *pgxpool.Pool, repo *kanamepg.Repository, acc domain.AccountID, name string, resources ...string) domain.RoleID {
	t.Helper()
