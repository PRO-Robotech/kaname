...
// доступа (kaname#319).
//
// Записей будет столько, сколько выпусков, и темп задаст арендатор: токен
// доступа выдаёт каждый обмен кода и каждая ротация, а запись обязан писать
// выпуск церемонии (провязка — kaname#396). Строку позволено снять не раньше
