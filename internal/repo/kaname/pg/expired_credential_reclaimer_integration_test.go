...
func reclaimSpec(grace time.Duration) kanamepg.ExpiredCredentialReclaimSpec {
	return kanamepg.ExpiredCredentialReclaimSpec{
...
func TestCredRcl01_ExpiredCredentialFreesItsPlaceUnderTheCeiling(t *testing.T) {
	...
	r := kanamepg.NewExpiredCredentialReclaimer(f.pool, "kaname")
