...
// ротация, отзыв семейства (второй отзыв — пустой, а не отказ), согласие и его
// отзыв, проверочное значение клиента. Исход каждого под конкуренцией —
// перепроверка условия, а не отказ сериализации.
//
...
// пустым, а не вторым — на названном уровне (`ceremonyWriterTx()`), где
