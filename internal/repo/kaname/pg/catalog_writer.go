...
// продукта #1034.
//
// # Почему писатель живёт РЯДОМ С ЧИТАТЕЛЕМ, а не на `kaname.Writer`
//
// Каталог — данные ПЛАТФОРМЫ, а `kaname.Writer` — писательская транзакция
...
//
// Форма — та, которую требует регламент от атомарного сравнения,
