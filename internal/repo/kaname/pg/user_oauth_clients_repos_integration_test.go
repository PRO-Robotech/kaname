...
//
// Запуск: `go test ./internal/repo/kaname/pg/... -run UserOAuthClient`. Skip с -short.
...
func insertUOC(t *testing.T, ctx context.Context, txb service.TxBeginner, repo *kanamepg.UserOAuthClientRepo, c domain.UserOAuthClient) domain.UserOAuthClient {
	t.Helper()
