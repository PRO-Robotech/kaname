...
// use-case.
func declareRole(t *testing.T, ctx context.Context, pool *pgxpool.Pool, repo kanamerepo.Repository,
...
func redeclareRole(t *testing.T, ctx context.Context, pool *pgxpool.Pool, repo kanamerepo.Repository,
...
// (`cmd/kaname/serve.go` → `installComposedModel`, между чтением доставки и
