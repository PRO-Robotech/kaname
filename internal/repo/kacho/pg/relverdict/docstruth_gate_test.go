...
// tablesUnderTheView выводит таблицы, которые цепь ФАКТИЧЕСКИ читает, из блока
// Up действующей миграции — с вырезанными комментариями.
//
// Вырезать обязательно: шапка миграции называет все девять таблиц десятки раз,
// объясняя их, и гейт по подстроке зеленел бы на собственном объяснении.
