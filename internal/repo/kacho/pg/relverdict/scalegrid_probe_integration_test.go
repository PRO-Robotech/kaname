...
//
// # Чего этот прибор НЕ утверждает
//
// Он не утверждает ничего о ПРОД-ПУТИ принятия решения: реляционный вердикт
// работает сегодня теневым компаратором, решение принимает прежний движок.
// Свойство, которое здесь доказывается, принадлежит реляционной форме —
// будущему заменителю.
//
