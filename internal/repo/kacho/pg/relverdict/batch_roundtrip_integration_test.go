...
//
// Три, а не один: транзакция чтения — это `begin`, сам вопрос и `rollback`.
// Величина объявлена ДО прогона и НЕ ЗАВИСИТ от числа идентификаторов — в этом
// и состоит утверждение.
const batchStatementCeiling = 3
