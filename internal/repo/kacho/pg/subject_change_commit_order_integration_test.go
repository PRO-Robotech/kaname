...
import (
	...
	"github.com/PRO-Robotech/kacho/services/iam/internal/repo/kacho"
...
type subjectChangeStand struct {
	ctx  context.Context
	pool *pgxpool.Pool
	repo *kachopg.SubjectChangeRepo
	ab   *kachopg.Repository
}
...
// очереди не бывает.
func (s *subjectChangeStand) beginWrite(t *testing.T, subjectID string) kacho.Writer {
	t.Helper()
