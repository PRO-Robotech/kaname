...
func TestDirtinessIsJudgedAgainstTheSubjectOfTheMeasurement(t *testing.T) {
	subject := []string{
		"services/iam/internal/repo/kacho/pg/scalegrid/grid.go",
		"services/iam/internal/repo/kacho/pg/scalegrid/census.go",
	}
	...
	t.Run("грязь ВНЕ предмета: замер воспроизводим, и шапка это говорит", func(t *testing.T) {
		...
		p.DirtyPathList = []string{
			"services/iam/internal/repo/kacho/pg/scalegrid/REPORT-R7-2-strength.txt",
			"services/iam/internal/repo/kacho/pg/scalegrid/REPORT-R7-3-matrix-volume.txt",
			"services/iam/internal/repo/kacho/pg/relverdict/REPORT-X.txt",
		}
		text := headerOf(t, p)
...
func TestDirtyPathsAreParsedFromPorcelain(t *testing.T) {
	out := " M services/iam/internal/repo/kacho/pg/scalegrid/grid.go\n" +
		"?? services/iam/internal/repo/kacho/pg/scalegrid/REPORT-R7-2-strength.txt\n" +
