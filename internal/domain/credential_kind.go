...
// закрыть.
//
// Различимость живёт ВНУТРЬ — в счётчиках и журнале по причинам, а не в
// тексте ошибки и не в ответе на проводе. Причина едет внутрь отказом-обёрткой
// ([RefuseBasicCredential]), чей текст дословно равен этому и для которого
// `errors.Is` с этим значением истинно.
