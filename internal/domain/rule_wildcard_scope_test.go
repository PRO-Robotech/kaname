...
// currently 0088, which appended `vpc.cidrGroup` (the named prefix set: its type was
...
// by authzmap/verb_type_materializable_test.go). Before it, 0074 array_remove'd the
// retired compute block-storage types out of the same row.
