...
// строка Ф2; F4d-13…F4d-15.
//
// Уровень доверия и состояние способа здесь НЕ заведены, и это решение, а не
// пропуск. Уровень есть функция вида способа: хранимый рядом, он стал бы вторым
// написанием одного значения, а «уровень уверенности как значение нашего
// хранилища» Ф1 §0.2 прямо относит к фазе Ф11 и не санкционирует. Состояния у
// способа сегодня ровно одно — «есть», и оно выражается существованием строки;
// словаря состояний не объявляет ни одна одобренная приёмка. Каждое заводится
// добавлением колонки с умолчанием, без переноса строк.
