...
// написанием одного значения, а само правило «вид → уровень» Ф1 §0.2 относит к
// своей фазе (Ф11) и не санкционирует. Состояния у способа сегодня ровно одно —
// «есть», и оно выражается существованием строки; словаря состояний не объявляет
// ни одна одобренная приёмка. Каждое заводится добавлением колонки с
// умолчанием, без переноса строк.
