...
// закрытом словаре службы и в ограничении схемы слова НЕТ. Пока его нет, отзыв
// обязан отказать ОПЕРАЦИЕЙ — громко, не назвав успехом отзыв, которого не было,
// и не записав семейству чужую причину.
//
