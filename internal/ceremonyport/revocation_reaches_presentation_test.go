...
// FamilyRevoked — ответ записи выпуска о семействе. Записей выпуска эта
// подставка не ведёт, как не ведёт их на этой ревизии и выпуск службы, поэтому
// ответ — законное «семейству не принадлежит».
func (m *memFamilies) FamilyRevoked(_ context.Context, _ string) (bool, error) {
	return false, nil
}
