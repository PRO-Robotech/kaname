...
//     непригодное действие (MOD-RL-19) она не считает: обе единицы требуют
//     сверки имени действия манифеста с именем действия каталога, а написание
//     действия в манифесте есть контракт генератора раздела `resources`, и
//     генератора сегодня нет.
