...
//
// Три записи каталога из 338 не несут сегмента версии вовсе
// (`corelib.operation.OperationService/Get` и рядом): это службы фундамента,
// ресурсом модуля они не являются. Отбрось их молча — и «ноль находок» станет
