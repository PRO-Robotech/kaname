...
// удостоверения, и подать её дублёром читателя нечем. С полосой ключа нашего
// эндпоинта она сличается на настоящей базе
// (`repo/kaname/pg/basic_credential_revoke_all_integration_test.go`).
//
