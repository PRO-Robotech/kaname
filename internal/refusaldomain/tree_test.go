...
//  3. производитель, чей домен ещё не взят у объявления, — он ОДИН и назван
//     ведомостью ниже. Записей было три, и две сняты вместе со своим предметом.
