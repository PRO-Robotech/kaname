...
//
// ОСТАТОК НАЗВАН, а не умолчан: путь последствий каталога отбирает у роли
// глагол либо сегмент, строки роли не трогая, — такой отзыв подписчику не
// виден. Заведён задачей `PRO-Robotech/kaname#76`; утверждение прибито §3 той
// же пробы и перевернётся вместе с починкой, а не разойдётся молча.
