...
> создано» помеченным утверждением — не в зелёное и не в красное. На стенде
> посадки `own` с листом края набор дал числовой вердикт трижды: 9/9 запросов,
> 32 утверждения, 0 упавших, «условие не создано» 0 (kaname#183, 2026-09-23;
> провенанс и числа — `docs/RESULTS.md`, раздел «Полоса входа паролем: числовой
> вердикт на стенде посадки `own`»).
