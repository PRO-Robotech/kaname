...
| reject | AUTHZ-ACCT-UP-OWN-AAA   | 400 + code 3 + текст      | 200 + Operation — имя вне контракта     |
...
LANES = {
    ...
    "reject": ("AUTHZ-ACCT-UP-OWN-AAA", (400, _OK_NAME_REJECT), (200, _OK_OPERATION), "iop00000000000000001"),
}
...
def main() -> int:
    ...
    print("\nselftest: OK — все полосы обоих наборов различают здоровый ответ и дефект, "
          "называют дефект в тексте падения, а прежняя форма не видела ни одного из них")
    return 0
