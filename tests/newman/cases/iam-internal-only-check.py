...
HOME_REASON = (
    ...
    "слушателе края и недостижимы на публичном cmux и на внешнем адресе. Производитель — "
    "край платформы; маршруты iam и geo здесь носители, а не предмет."
)
...
# посева церемонии (`PRO-Robotech/kacho:tests/authz-fixtures/prodseed_ceremony.py::_mirror_lookup`,
