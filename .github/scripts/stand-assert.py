...
ЧЕГО ЗДЕСЬ НЕТ И ПОЧЕМУ. Сквозной набор newman адресуется в большинстве модулей
кейсов к КРАЮ ПЛАТФОРМЫ (сколько именно — печатает `newman-suite-debt.py`; число
здесь не выписано: каждая переадресованная коллекция его сдвигает), и край — не
транспорт: он производит проверяемые свойства
