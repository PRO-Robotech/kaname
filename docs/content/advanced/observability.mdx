...
<table>
  ...
  <tbody>
    ...
    <tr><td><strong>Сброс кэша края</strong></td><td>Темп записи в <code>subject_change_outbox</code> и рейт <code>PollSubjectChanges</code>. Отставание живёт <strong>у читателя</strong>: журнал читает сам api-gateway курсором, и «докуда дочитали» со стороны iam не видно. Глубина журнала растёт монотонно и отставанием <strong>не является</strong></td></tr>
