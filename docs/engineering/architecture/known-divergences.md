...
**Что здесь НЕ решается.** Чем читать журнал смены субъекта — курсором, как
сегодня, полосой «системного потребителя» в общей форме либо отдельным
предметом — остаётся развилкой задачи **#1397**, и она продуктовая. Настоящая
запись говорит только то, что от исхода той развилки не зависит: журнал смены
субъекта — не частный случай ресурсного потока, поэтому владельцем ресурсного
потока iam не станет ни при одном из трёх исходов.
