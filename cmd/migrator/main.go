...
// exitCodeFor — класс отказа наката.
//
// ЗДЕСЬ ПОКА ОДИН КЛАСС НА ВСЁ, и это действующее поведение, а не замысел:
// накатчик отвечает `1` на любой отказ, включая недостижимую базу. Различение
// заведено пробами рядом (`outcome_class_test.go`) и ещё не исполнено.
