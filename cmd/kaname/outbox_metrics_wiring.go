...
//
// `kaname.fga_outbox` — та самая очередь, через которую физически уходит
...
//
// `kaname.subject_change_outbox` доставляет инвалидацию кэша решений о
...
const auditOutboxTable = "kaname.audit_outbox"
