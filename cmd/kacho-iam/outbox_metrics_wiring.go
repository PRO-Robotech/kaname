...
// развёрнуто, потребитель читает журнал КУРСОРОМ (`id > $1`) и `sent_at` не
// трогает. Величины «возраст самой старой неотправленной» и «число отравленных»
// после этого описывают не сбой, а устройство: они растут на исправной службе и
// растут всегда.
//
