...
var deliveryRoster = []string{
	...
	"block_switch_is_boolean_injection_test.go",
	"block_switch_is_boolean_test.go",
	...
	"provider_admin_pair_injection_test.go",
	"provider_admin_pair_test.go",
	"surface_can_be_switched_off_test.go",
	"operator_supplied_roster_injection_test.go",
	"operator_supplied_roster_test.go",
	"outbound_lane_has_an_operator_knob_injection_test.go",
	...
	"pod_env_source_recognizer_test.go",
	...
	"provider_hops_injection_test.go",
	"provider_hops_test.go",
	"stack_chains_read_the_table_injection_test.go",
	"stack_chains_read_the_table_test.go",
