...
func (x *UpsertFromIdentityRequest) Reset() {
	*x = UpsertFromIdentityRequest{}
	mi := &file_kaname_cloud_iam_v1_internal_user_service_proto_msgTypes[0]
...
func (*UpsertFromIdentityRequest) Descriptor() ([]byte, []int) {
	return file_kaname_cloud_iam_v1_internal_user_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *UpsertFromIdentityMetadata) Reset() {
	*x = UpsertFromIdentityMetadata{}
	mi := &file_kaname_cloud_iam_v1_internal_user_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpsertFromIdentityMetadata) Descriptor() ([]byte, []int) {
	return file_kaname_cloud_iam_v1_internal_user_service_proto_rawDescGZIP(), []int{1}
}
...
var (
	...
	file_kaname_cloud_iam_v1_internal_user_service_proto_rawDescData []byte
)

func file_kaname_cloud_iam_v1_internal_user_service_proto_rawDescGZIP() []byte {
	file_kaname_cloud_iam_v1_internal_user_service_proto_rawDescOnce.Do(func() {
		file_kaname_cloud_iam_v1_internal_user_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_kaname_cloud_iam_v1_internal_user_service_proto_rawDesc), len(file_kaname_cloud_iam_v1_internal_user_service_proto_rawDesc)))
	})
...
func init() { file_kaname_cloud_iam_v1_internal_user_service_proto_init() }
func file_kaname_cloud_iam_v1_internal_user_service_proto_init() {
	if File_kaname_cloud_iam_v1_internal_user_service_proto != nil {
		return
	}
	file_kaname_cloud_iam_v1_user_proto_init()
	file_kaname_cloud_iam_v1_user_service_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_kaname_cloud_iam_v1_internal_user_service_proto_goTypes,
		DependencyIndexes: file_kaname_cloud_iam_v1_internal_user_service_proto_depIdxs,
		MessageInfos:      file_kaname_cloud_iam_v1_internal_user_service_proto_msgTypes,
	}.Build()
	File_kaname_cloud_iam_v1_internal_user_service_proto = out.File
	file_kaname_cloud_iam_v1_internal_user_service_proto_goTypes = nil
	file_kaname_cloud_iam_v1_internal_user_service_proto_depIdxs = nil
}
